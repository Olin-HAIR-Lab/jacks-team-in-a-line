'''
Currently contains the original Simulation.py file copied directly from the
module 3 repository. Runs a simulated map matching the physical setup that
exists in the room.
'''
